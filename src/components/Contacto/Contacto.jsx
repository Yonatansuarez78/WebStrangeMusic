                              ...
                              <div className="row">
                                  ...
                                  <div className="col-md-6">
                                      ...
                                      <div className="socials">
                                          <ul>
                                              <li>
                                                  <a href="https://github.com/Yonatansuarez78" target="_blank">
                                                      <span className="ico-circle"><i className="ion-social-github"></i></span>
                                                  </a>
                                              </li>
                                              <li>
                                                  <a href="https://www.instagram.com/yonatan_suarez78/" target="_blank">
                                                      <span className="ico-circle"><i className="ion-social-instagram"></i></span>
                                                  </a>
                                              </li>
                                              <li>
                                                  <a href="https://twitter.com/YonatanPechene" target="_blank">
                                                      <span className="ico-circle"><i className="ion-social-twitter"></i></span>
                                                  </a>
                                              </li>
                                              <li>
                                                  <a href="https://www.facebook.com/Yonatan.suarez08" target="_blank">
                                                      <span className="ico-circle"><i className="ion-social-facebook"></i></span>
                                                  </a>
                                              </li>
                                              <li>
                                                  <a href="https://www.linkedin.com/in/yonatansuarez78/" target="_blank">
                                                      <span className="ico-circle"><i className="ion-social-linkedin"></i></span>
                                                  </a>
                                              </li>
                                          </ul>
                                      </div>
