      ...
      <main className="container-fluid">
        ...
        <div className="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center">
          <div className="col-md-6 p-lg-5 mx-auto my-5">
            ...
            <h3 className="fw-normal text-muted mb-3">En esta sesion encontraras nuevos ritmos musicales</h3>
          ...
          <div className="col-md-6">
            <div className="text-bg-dark me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
              <div className="my-3 py-3">
                ...
                <p className="lead">Donde la salsa se convierte en un viaje de pasión y alegría a través de la música.</p>
              </div>
              <div className="bg-body-tertiary shadow-sm mx-auto" style={{ width: '80%', height: '300px', borderRadius: '21px 21px 0 0' }}></div>
            </div>
          </div>
